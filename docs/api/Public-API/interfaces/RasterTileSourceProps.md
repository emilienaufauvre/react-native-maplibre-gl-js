[react-native-maplibre-gl-js](../../index.md) / [Public API](../index.md) / RasterTileSourceProps

# RasterTileSourceProps

Defined in: [src/react-native/components/map-sources/RasterTileSource/RasterTileSource.types.ts:9](https://github.com/emilienaufauvre/react-native-maplibre-gl-js/blob/main/src/react-native/components/map-sources/RasterTileSource/RasterTileSource.types.ts#L9)
