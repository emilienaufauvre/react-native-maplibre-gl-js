...
> **MapProviderProps** = \{ `style?`: `StyleProp`\<`ViewStyle`\>; `webViewStyle?`: `StyleProp`\<`ViewStyle`\>; `cssStyles?`: `string` \| `string`[]; `rnLoggerEnabled?`: `boolean`; `webLoggerEnabled?`: `boolean`; `webMessageOptions?`: [`WebMessageOptions`](WebMessageOptions.md); `children?`: `ReactNode`; \}
