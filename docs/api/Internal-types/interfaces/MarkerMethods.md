...
Defined in: [src/react-native/components/Marker/Marker.types.ts:35](https://github.com/emilienaufauvre/react-native-maplibre-gl-js/blob/main/src/react-native/components/Marker/Marker.types.ts#L35)
