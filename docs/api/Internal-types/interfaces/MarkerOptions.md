...
Defined in: [src/react-native/components/web-objects/Marker/Marker.types.ts:47](https://github.com/emilienaufauvre/react-native-maplibre-gl-js/blob/main/src/react-native/components/web-objects/Marker/Marker.types.ts#L47)
...
| <a id="element"></a> `element?` | `HTMLElementDescriptor` | `undefined` | - | [src/react-native/components/web-objects/Marker/Marker.types.ts:50](https://github.com/emilienaufauvre/react-native-maplibre-gl-js/blob/main/src/react-native/components/web-objects/Marker/Marker.types.ts#L50) |
