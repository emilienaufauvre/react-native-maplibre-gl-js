...
| [WebObjectOptionsInferred](type-aliases/WebObjectOptionsInferred.md) | Options that are used to instantiate a web object. Filter out those options that cannot be set from the RN world and replace them with the given replacements (HTMLElement that cannot be instantiated in RN are replaced by HTMLElementDescriptor and web functions that cannot be instantiated in RN are replaced by WebFunctionDescriptor). Also, remove the ones that should not be specified and used. |
...
Re-exports [WebObjectListenerOnRN](../Public-API/type-aliases/WebObjectListenerOnRN.md)

***

### WebObjectListenerOnObject

Re-exports [WebObjectListenerOnObject](../Public-API/type-aliases/WebObjectListenerOnObject.md)

***

### WebObjectListenerOnMapLayer

Re-exports [WebObjectListenerOnMapLayer](../Public-API/type-aliases/WebObjectListenerOnMapLayer.md)

***

### WebObjectListenerOnHTMLElement

Re-exports [WebObjectListenerOnHTMLElement](../Public-API/type-aliases/WebObjectListenerOnHTMLElement.md)

***

### MapSourceLayer

Re-exports [MapSourceLayer](../Public-API/interfaces/MapSourceLayer.md)

***

### MapSourceLayerListeners

Re-exports [MapSourceLayerListeners](../Public-API/interfaces/MapSourceLayerListeners.md)

***

### MapSourceId

Re-exports [MapSourceId](../Public-API/type-aliases/MapSourceId.md)

***

### MapSourceLayerId

Re-exports [MapSourceLayerId](../Public-API/type-aliases/MapSourceLayerId.md)
